...
## Inquiry: 
We have all experienced the excitement of being recommended an interesting movie, only to google it and find it has very mediocre ratings on Rotten Tomatoes. This project will explore the breakdown of these ratings, comparisons to public forum sentiment, and what specific biases might exist with using a wide critic rating system.
